...
class Evaluator(object):
    def __init__(self, model, visiual=True):
        ...
        self.pred_result_path = os.path.join(cfg.PROJECT_PATH, 'data', 'results_' + str(cfg.TRAIN["LR_INIT"]))
    ...
    def APs_voc(self, multi_test=False, flip_test=False):
        ...
        for img_ind in tqdm(img_inds):
            ...
            if bboxes_prd.shape[0]!=0 and self.__visiual and self.__visual_imgs < 100:
                ...
                path = os.path.join(cfg.PROJECT_PATH, "data/results_" + str(cfg.TRAIN["LR_INIT"]) + "/{}.jpg".format(self.__visual_imgs))
